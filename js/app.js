(() => {
    ...
    function initSliders() {
        if (document.querySelector(".top")) new core(".top__slider", {
            modules: [ Autoplay ],
            observer: true,
            observeParents: true,
            slidesPerView: 1,
        ...
        if (document.querySelector(".article-slider")) new core(".article-slider__slider", {
 ...
 */
    ...
    da.init();
    let block = document.querySelector(".btn-menu");
    block.addEventListener("click", (() => {
        if (block.classList.contains("btn-menu")) {
            document.querySelector(".menu__obol").classList.toggle("_active");
            document.querySelector(".header__btn").classList.toggle("_active");
        }
    }));
    window["FLS"] = true;
    isWebp();
    ...
    var containerEl = document.querySelector('[data-ref="galleryfirst"]');
    if (containerEl) mixitup(containerEl, {
        load: {
            filter: ".catrgory-a"
        }
    });
